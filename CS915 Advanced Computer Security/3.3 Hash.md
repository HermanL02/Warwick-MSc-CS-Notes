...
So, a hash function with n bit output would have 2^(n/2) random input messages. 
The actual security level is only half of the bits, for a 160 bits, only 80 bits security can be secured. 
